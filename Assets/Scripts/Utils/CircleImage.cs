...
/**
 * 该组件来自：https://github.com/HanxianshengGame/UGUI_CircleImage
 */
public class CircleImage : Image {
    ...
    protected override void OnPopulateMesh(VertexHelper vertexHelper) {
        segementCount = 100;
        // 渲染圆所需要的顶点数
        circleVertexCount = segementCount + 2;
        ...
        // 利用当前Image的宽高和UV宽高计算出X,Y轴上的UV转换系数(uvScaleX,uvScaleY)(每1单位的position所占的uv值)
